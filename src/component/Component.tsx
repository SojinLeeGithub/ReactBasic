...
// JSX / TSX :
// JSX (JavaScript XML) / TSX (TypeSript XML)
...
// VS Code의 ES7+ /React/Redux/React-Native snippets 확장 설치 후
// 단축 명령으로 컴포넌트를 생성할 수 있다.

// 클래스형 : rcc (react class component) 단축 명령으로 생성 가능
// 클래스의 이름 = 파일명과 동일하게 작성된다.
...
// 함수형 : rfc (react function component) 단축 명령으로 생성 가능
// 함수명 = 파일명과 동일하게 작성됨
...
export default function Component () {
    ...
    // - 여러가지 자바스크립트 연산자를 사용할 수 있다.

    // - 반드시 하나의 요소만 반환 가능 (0개 x, 2개 이상 x)
    // - 다수의 요소를 반환하고 싶다면 최상단의 부모 요소로 묶어주어야 한다.
    // - 부모 요소로 묶을 때 <></>를 이용하여 의미없는 태그를 생성할 수 있다.
